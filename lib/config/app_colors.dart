...
class AppColors {
  ...
  // ============================================
  static const Color background = Color.fromRGBO(249, 252, 227, 0.898);  // الزهري الفاتح زي البروتوتايب
  static const Color cardBg = Color(0xFFEFF5E9);       // أخضر فاتح للكاردات
